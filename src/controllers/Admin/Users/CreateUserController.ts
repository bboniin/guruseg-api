...
class CreateUserController {
    async handle(req: Request, res: Response) {
        const { name, email, collaborator_id, password, phone_number, resale, course, course_restricted } = req.body
        ...
        const user = await createUserService.execute({
            name, email, phone_number, collaborator_id, password, photo, courseBoolean, resaleBoolean, courseRestricted
        })
