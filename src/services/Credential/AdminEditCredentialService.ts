...
class AdminEditCredentialService {
    async execute({ id, visible, description, photo, email, password, name, phone_number, rg, cpf, state, city, served_cities, birthday, services, profession }: CredentialRequest) {
